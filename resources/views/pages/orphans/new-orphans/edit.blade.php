<x-main-layout>
    ...
    <h2 class="mb-5"> تعديل بيانات اليتيم </h2>

    <div class="supporters bg-white rounded shadow-sm p-3">

        <form action="{{route('orphan.registered.update' , $orphan->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
    ...
    @push('scripts')
        ...
        <script>
            ...
            const selectedCenter = @json($orphan->profile->center);
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                function toggleClassSection() {
                    ...
                    if (selectedDetail === 'ابتدائي' || selectedDetail === 'إعدادي') {
