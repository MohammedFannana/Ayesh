...
<div class="orphans_form">
        ...
        <div class="row orphans-form" style="justify-content:between;">
            ...
            <div class="col-12 col-md-6 mb-3">
                ...
                <x-form.select name="case_type"
                    :options="['' =>  __('اختر'), 'يتيم الأبوين' => __('يتيم الأبوين'), 'مريض مزمن' => __('مريض مزمن'), 'حالات خاصة' => __('حالات خاصة'), 'قريب السن' => __('قريب السن')]"/>
            ...
            {{-- mother_name --}}
            <div class="col-12 col-md-6 mb-3">
                <x-form.input name="mother_name" class="border" type="text" label=" {{__('اسم الأم')}}" autocomplete="" placeholder="{{__('أدخل اسم الأم')}}"/>
            </div>
    ...
    <div class="bg-white p-3 mb-3 rounded shadow-sm">
        ...
        <div class="row" style="justify-content:between;">
            ...
            {{-- phone --}}
            <div class="col-12 col-md-6 mb-3">
                <x-form.input name="phone" class="border" type="text" label=" {{__('رقم التليفون')}}" autocomplete="" placeholder="{{__('أدخل رقم التليفون')}}"/>
            </div>

            {{-- address --}}
            <div class="col-12 col-md-6 mb-3">
                <x-form.input name="full_address" class="border" type="text" label="  {{__('العنوان بالكامل')}}" autocomplete="" placeholder=" {{__('أدخل العنوان بالكامل')}}" />
            </div>

            {{--  governorate --}}
            <div class="col-12 col-md-6 mb-3">
                <x-form.input name="governorate" class="border" type="text" label="  {{__('المحافظة')}} " autocomplete="" placeholder=" {{__('أدخل اسم المحافظة')}}" />
            </div>

            {{-- center --}}
            <div class="col-12 col-md-6 mb-3">
                <x-form.input name="center" class="border" type="text" label="  {{__('المركز')}} " autocomplete="" placeholder=" {{__('أدخل اسم المركز')}}" />
            </div>

            {{-- recipient_name --}}
            <div class="col-12 col-md-6 mb-3">
                <x-form.input name="recipient_name" class="border" type="text" label=" {{__('اسم المستلم')}} " autocomplete="" placeholder=" {{__('أدخل اسم المستلم')}} " />
            </div>

            {{-- registrar_name --}}
            <div class="col-12 col-md-6 mb-3">
                <x-form.input name="registrar_name" class="border" type="text" label="  {{__('التسجيل')}} " autocomplete="" placeholder=" {{__('أدخل اسم المسجل')}}" />
            </div>
            ...
            {{-- knowledge --}}
            <div class="col-12 mb-3">
                <x-form.input name="knowledge" class="border" type="text" label=" {{__('ماهى اليه معرفتكم بجمعية عايش')}}" autocomplete="" placeholder=" {{__('كيف تعرفتم على جمعية عايش')}}"/>
            </div>
