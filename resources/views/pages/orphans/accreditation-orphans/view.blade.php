    ...
    <div class="orphans-view bg-white rounded shadow-sm p-3 mb-4">
        ...
        <div>
            ...
            <form action="{{route('orphan.accreditation.store', $orphan->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex flex-column  mb-4">
                    ...
                    <div class="d-flex gap-5" >
                        ...
                        <div class="d-flex gap-1">
                            ...
                            <label for="approved" class="title">{{__('قبول الملف')}}</label>
                        </div>
                ...
                <div class="mb-4">
                    <x-form.input name="name" class="border" type="text" label=" {{__('اسم المعتمد')}}" autocomplete="" placeholder="أدخل اسم المعتمد " value="{{auth()->user()->name}}"/>
                </div>
