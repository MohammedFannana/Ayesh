<x-main-layout>
    ...
    <div class="orphons bg-white rounded shadow-sm p-3">
        ...
        <div class="intro d-flex  align-items-center" style="gap: 60px">

            {{-- title and count --}}
            <div>
                <p class="title-color fs-5 fw-semibold mb-1"> الحالات المقدمة للتسويق </p>
                <p class="check-count" style="display:none"> 1 عنصر </p>
            </div>
            ...
            <div class="uplode-button" style="display:none">
                ...
                <a href="" class="btn btn-danger ps-4 pe-4"> الغاء </a>
            </div>
        ...
        <table class="table">
            <thead>
                ...
                <tr>
                    <th scope="col">  </th>
                    <th scope="col">كود اليتيم الداخلي</th>
            ...
            <tbody>
                ...
                <tr>
                    <td> <input type="checkbox" name="orphan_check" class="orphan_check"> </td>
                    <td scope="row">1</ف>
                    <td>محمد احمد</td>
