<x-main-layout>
    ...
    <form action="{{route('orphan.marketing.sharjah.store')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="row orphans-form" style="justify-content:between;">
            ...
            {{-- responsible --}}
            <div class="col-12 col-md-6 mb-3">
                <x-form.input name="guardian_name" :value="$orphan->guardian->guardian_name" class="border" type="text" label="  {{__('ولي أمر أو المسئول المباشر عن اليتيم ')}}" autocomplete="" placeholder="أدخل  المسئول المباشر عن اليتيم" disabled/>
            </div>
            ...
            {{-- income --}}
            <div class="col-12 col-md-6 mb-3">
                <x-form.input name="income" :value="$orphan->family->income" class="border" type="text" label=" {{__('دخل الأسرة')}}" autocomplete="" placeholder="أدخل الدخل" disabled/>
            </div>
