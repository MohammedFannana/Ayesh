<x-main-layout>
    ...
    <div class="orphons bg-white rounded shadow-sm p-3">
        ...
        <div class="intro d-flex row align-items-center">
            ...
            {{-- title and count --}}
            <div class="col-3">
                <p class="title-color fs-5 fw-semibold mb-1"> {{__('الحالات المؤرشفة')}}</p>
            ...
            <div class="search mb-1 w-50" >
                ...
                <form action="{{route('orphan.archived.index')}}" method="get" class="input-group flex-nowrap">
                    @csrf
                ...
                @empty
                    ...
                    <tr>
                        <td colspan="6" class="text-center fs-5 rounded text-white" style="background-color: var(--title-color)">
                            {{__('لا يوجد أيتام على القائمة المؤرشفة')}}
                        </td>
                    </tr>
