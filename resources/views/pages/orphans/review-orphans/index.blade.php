<x-main-layout>
    ...
    <div class="orphons bg-white rounded shadow-sm p-3">
        ...
        <div class="intro d-flex justify-content-between align-items-center">
            <div>
                <p class="title-color fs-5 fw-semibold mb-1"> {{__('الحالات قيد المراجعة')}}</p>
            </div>

            <form action="{{route('orphan.review.index')}}" method="GET" class="search mb-1 w-75">
                ...
                @forelse ($orphans as $orphan)
                    ...
                    <tr>
                        ...
                        <td style="position: relative;">
                            ...
                            <div class="action" >
                                <a href="{{route('orphan.review.show' , $orphan->id)}}" class="text-decoration-none">
                                ...
                                <form action="{{route('orphan.review.destroy' , $orphan->id )}}" method="post" style="margin-right: -5px">
                                    @csrf
                                    @method('delete')
