<x-main-layout>
    ...
    <h4 class="mb-4 title-color"> إضافة مبلغ </h4>
        ...
        <div class="bg-white p-3 mb-4 rounded shadow-sm">
            <div class="row">
                ...
                <div class="col-12 col-md-6 mb-3">
                    <x-form.input name="donor_number"  class="border" type="text" label=" رقم المتبرع "  placeholder="أدخل رقم المتبرع "/>
                </div>


                <!--  donor_name -->
                <div class="col-12 col-md-6 mb-3">
                    <x-form.input name="donor_name"  class="border" type="text" label=" اسم المتبرع "  placeholder="أدخل اسم المتبرع "/>
                </div>
