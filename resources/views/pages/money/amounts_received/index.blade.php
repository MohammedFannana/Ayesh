<x-main-layout>
    ...
    <div class="bg-white rounded p-3 shadow">
        ...
        <div class="row justify-content-between p-3 mb-3" >
            <a href="" class="btn col-4 fw-semibold" style="background-color: #D8ECD4"> المقبوضات </a>
            <a href="" class="btn col-4  title" style="background-color: #F4F4F4"> المدفوعات </a>
            <a href="" class="btn add-button col-2" type="button"> إضافة مبلغ </a>
        </div>
