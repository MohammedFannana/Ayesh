            ...
            <div class="bg-white p-3 mb-3 rounded shadow-sm">
                <div class="row orphans-form" style="justify-content:between;">
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="families_number"  class="border" type="text" label=" {{__('رقم الأسرة ')}}"  placeholder="أدخل رقم الأسرة "/>
                    </div>

                    <!--  authority_number -->
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="authority_number"  class="border" type="text" label=" {{__('رقم الهيئة ')}}"  placeholder="أدخل رقم الهيئة "/>
                    </div>

                    <!--  authority_name -->
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="authority_name"  class="border" type="text" label=" {{__('اسم الهيئة ')}}"  placeholder="أدخل اسم الهيئة "/>
                    </div>

                    <!--  country -->
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="country"  class="border" type="text" label=" {{__('الدولة')}} "  placeholder="أدخل اسم الدولة "/>
                    </div>

                    <!--  city -->
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="city"  class="border" type="text" label=" {{__('المدينة')}} "  placeholder="أدخل اسم المدينة "/>
                    </div>
                    ...
                    <!--  name -->
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="name"  class="border" type="text" label=" {{__('الاسم الكامل ')}}"  placeholder="أدخل  الاسم الكامل "/>
                    </div>

                    <!--  nationality -->
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="nationality"  class="border" type="text" label=" {{__('الجنسية')}}  "  placeholder="أدخل  الجنسية "/>
                    </div>
                    ...
                    <!--  marital_status -->
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="marital_status"  class="border" type="text" label="  {{__('الحالة الاجتماعية ')}}"  placeholder="أدخل  الحالة الاجتماعية "/>
                    </div>

                    {{-- family_number --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="family_number" class="border" type="number" label=" {{__('عدد أفراد العائلة')}}"  autocomplete="" min="0" placeholder="أدخل عدد أفراد العائلة"/>
                    </div>

                    {{-- male_number --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="family_male_number" class="border" type="number" label=" {{__('عدد الابناء ')}}" autocomplete="" min="0" placeholder="أدخل عدد الابناء "/>
                    </div>

                    {{-- female_number --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="family_female_number" class="border" type="number" label=" {{__('عدد البنات ')}}" autocomplete="" min="0" placeholder="أدخل عدد البنات "/>
                    </div>
                    ...
                    {{-- income_source --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="income_source" class="border" type="text" label=" {{__('المصدر')}} " autocomplete="" placeholder="أدخل مصدر الدخل"/>
                    </div>

                    {{-- subsidies --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="subsidies" class="border" type="text" label=" {{__('الإعانات الاخرى و قدرها ')}}" autocomplete="" placeholder="أدخل الإعانات الاخرى و قدرها"/>
                    </div>
                    ...
                    {{-- birth --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="birth" class="border" type="text" label=" {{__('الولادة')}} " autocomplete="" placeholder="أدخل مكان الولادة"/>
                    </div>

                    {{-- family_city --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="family_city" class="border" type="text" label=" {{__('المدينة')}} " autocomplete="" placeholder="أدخل اسم المدينة"/>
                    </div>

                    {{-- family_directorate --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="family_directorate" class="border" type="text" label=" {{__('المديرية')}} " autocomplete="" placeholder="أدخل اسم المديرية"/>
                    </div>

                    {{-- family_village --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="family_village" class="border" type="text" label=" {{__('القرية')}} " autocomplete="" placeholder="أدخل اسم القرية"/>
                    </div>

                    {{-- family_neighborhood --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="family_neighborhood" class="border" type="text" label=" {{__('الحي')}} " autocomplete="" placeholder="أدخل اسم الحي"/>
                    </div>

                    {{-- landmark --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="landmark" class="border" type="text" label=" {{__('أقرب معلم ')}}" autocomplete="" placeholder="أدخل أقرب معلم"/>
                    </div>
                    ...
                    {{-- researcher_name --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="researcher_name" class="border" type="text" label="  {{__('اسم الباحث ')}}" autocomplete="" placeholder="أدخل اسم الباحث "/>
                    </div>
                    ...
                    {{-- phone --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="phone" class="border" type="text" label="  {{__('رقم الهاتف ')}}" autocomplete="" placeholder="أدخل رقم الهاتف "/>
                    </div>
                    ...
                    {{-- authority_official --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="authority_official" class="border" type="text" label=" {{__('اسم مسؤول الهيئة ')}}" autocomplete="" placeholder="أدخل اسم مسؤول الهيئة "/>
                    </div>
