<x-main-layout>
    ...
    <h2 class="mb-4"> {{translate_text($supporter->name)}} </h2>
    ...
    <div class="case-list bg-white rounded shadow-sm p-3 mb-4">
        ...
        <div class="intro d-flex justify-content-between align-items-center">
            ...
            <form method="GET" action="{{route('supporter.list.sponsored' , $supporter->id)}}" class="search mb-1 w-75">
                ...
                <div class="input-group flex-nowrap">
                    ...
                    <input type="text" name="search" class="form-control" placeholder="{{__('البحث عن مكفولين')}}"  aria-describedby="addon-wrapping">
                </div>
