<x-main-layout>
    ...
    <div class="supporters bg-white rounded shadow-sm p-3">
        ...
        <div class="intro d-flex justify-content-between align-items-center">
            ...
            <form action="{{route('supporter.index')}}" method="GET" class="search mb-1 col-9">
                ...
                <div class="input-group flex-nowrap">
                    ...
                    <input type="text" name="search" class="form-control" placeholder="البحث عن داعم"  aria-describedby="addon-wrapping">
                </div>
