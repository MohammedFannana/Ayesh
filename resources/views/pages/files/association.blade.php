<x-main-layout>
    ...
    <div>
        ...
        <div class="col-12  mb-4">
            <label class="mb-3 title-color fs-5"> الجمعيات  </label> <br>
            ...
            <div class="action">
                <form action="">
                    <div class="d-flex align-items-center gap-2 mb-1">
                        ...
                        <label for="" class="count"> جمعية دار البر </label>
                    </div>


                    <div class="d-flex align-items-center gap-2 mb-1">
                        <input type="radio" name="filter" id="">
                        <label for="" class="count"> جمعية الشارقة </label>
                    </div>

                    <div class="d-flex align-items-center gap-2 mb-1">
                        <input type="radio" name="filter" id="">
                        <label for="" class="count"> جمعية المجموعة </label>
                    </div>

                    <div class="d-flex align-items-center gap-2 mb-1">
                        <input type="radio" name="filter" id="">
                        <label for="" class="count"> جمعية دبي الخيرية </label>
                    </div>
