<x-main-layout>
    ...
    <div>
        ...
        <div class="col-12  mb-4">
            <label class="mb-3 title-color fs-5"> المشاريع  </label> <br>
            ...
            <div class="action">
                <form action="">
                    <div class="d-flex align-items-center gap-2 mb-1">
                        ...
                        <label for="" class="count"> مشروع </label>
                    </div>


                    <div class="d-flex align-items-center gap-2 mb-1">
                        <input type="radio" name="filter" id="">
                        <label for="" class="count"> ملف </label>
                    </div>

                    <div class="d-flex align-items-center gap-2 mb-1">
                        <input type="radio" name="filter" id="">
                        <label for="" class="count"> اجراء </label>
                    </div>

                    <div class="d-flex align-items-center gap-2 mb-1">
                        <input type="radio" name="filter" id="">
                        <label for="" class="count"> مهمة </label>
                    </div>

                    <div class="d-flex align-items-center gap-2 mb-1">
                        <input type="radio" name="filter" id="">
                        <label for="" class="count">جزء من مهمة </label>
                    </div>
    ...
    <div class="bg-white d-flex justify-content-between border rounded p-2" style="width: 35%">
        ...
        <div class="d-flex gap-3 align-items-center">
            ...
            <div>
                <p class="fs-5 fw-semibold mb-2">ملف مشروع.pdf</p>
                <p class="title-color mb-1"> مشروع </p>
