            ...
            <div class="bg-white p-3 mb-3 rounded shadow-sm">
                ...
                <div class="row" style="justify-content:between;">
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="supervising_authority"  class="border" type="text" label="  {{__('اسم الجهة المشرفة ')}}"  placeholder="أدخل اسم الجهة المشرفة"/>
                    </div>
                    ...
                    {{-- :value="$admin->email" --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="supervising_authority_country"  class="border" type="text" label=" {{__('الدولة')}} " placeholder="أدخل الدولة"/>
                    </div>
                    ...
                    {{-- sponsor_number --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="sponsor_number" class="border" type="text" label=" {{__('رقم ملف الكافل ')}}" autocomplete="" placeholder="أدخل رقم ملف الكافل"/>
                    </div>
                    ...
                    {{-- orphan_number --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="orphan_code" id="orphan_code" class="border" type="text" label="  {{__('رقم ملف اليتيم ')}}" autocomplete="" placeholder=" أدخل رقم ملف اليتيم "/>
                    </div>

                    {{-- orphan_nationality --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="nationality" id="nationality" class="border" type="text" label="  {{__('جنسية اليتيم ')}}" autocomplete="" placeholder=" أدخل جنسية اليتيم  "/>
                    </div>

                    {{-- orphan_age --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="age" id="age" class="border" type="text" label="  {{__('عمر اليتيم ')}}" autocomplete="" placeholder=" أدخل عمر اليتيم  "/>
                    </div>


                    {{-- Health status --}}
                    <div class="col-12  mb-3">
                        <x-form.textarea name="health_status" id="health_status" label="{{__('الحالة الصحية لليتيم')}}"  placeholder="أدخل الحالة الصحية لليتبم"/>
                    </div>
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="orphan_obligations_islam" class="border" type="text" label=" {{__('التزامات اليتيم بتعاليم الاسلام ')}}" autocomplete="" placeholder="أدخل التزامات اليتيم بتعاليم الاسلام"/>
                    </div>

                    {{-- save_orphan_quran --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="save_orphan_quran" class="border" type="text" label=" {{__('حفظ اليتيم من القران الكريم ')}}" autocomplete="" placeholder="أدخل حفظ اليتيم من القران الكريم"/>
                    </div>

                    {{-- person_responsible--}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="guardian_name" id="guardian_name" class="border" type="text" label=" {{__('المسؤول المباشر عن اليتيم')}}" autocomplete="" placeholder="أدخل المسؤول المباشر عن اليتيم"/>
                    </div>

                    {{-- relationship_orphan --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="guardian_relationship" id="guardian_relationship" class="border" type="text" label=" {{__('صلته باليتيم')}}" autocomplete="" placeholder="أدخل صلته باليتيم"/>
                    </div>
                    ...
                    <div class="col-12  mb-3">
                        <x-form.textarea name="authority_comment_guarantee" label=" {{__('تعليق الهيئة على أثر الكفالة ')}}"  placeholder="أدخل تعليق الهيئة على أثر الكفالة"/>
                    </div>
