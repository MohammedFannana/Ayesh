<x-main-layout>
    ...
    <div class="bg-white p-3 rounded shadow-sm">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="count ">
                <h5 class="title-color">{{__('تقارير الشارقة الخيرية')}}</h5>
                {{$count}} {{__('تقرير')}}
            </div>
            ...
            <div class="search mb-1 w-50">
                ...
                <form action="{{route('report.index' , $supporter_id)}}" method="GET" class="input-group flex-nowrap">
                    ...
                    <input type="text" name="search" class="form-control" placeholder="{{__('البحث عن تقرير')}}"  aria-describedby="addon-wrapping">
                </form>
                    ...
                    <div class="d-flex gap-3 align-items-center">
                        ...
                        <div>
                            ...
                            <p style="color: #C1C1C1">
                                {{__('اخر تحديث')}}: {{ $report->formatted_updated_at }}
                            </p>
                        </div>
                    ...
                    <div class="d-flex flex-end mt-2" style="position: relative; ">
                        ...
                        <div class="action" style="top:18px; width:170px" >
                            ...
                            <form action="{{route('report.destroy' , $report->id)}}" method="post" style="margin-right: -5px">
                                @csrf
                                @method('delete')
                                <button class="submit border-0 bg-transparent p-0">
        ...
        <div class="bg-white fs-5 p-2 w-100 text-danger text-center" >
