            ...
            <div class="bg-white p-3 mb-3 rounded shadow-sm">
                ...
                <div class="row" style="justify-content:between;">
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="orphan_number" id="orphan_code" class="border" type="text" label="  {{__('رقم اليتيم')}}" autocomplete="" placeholder=" {{__('أدخل رقم اليتيم')}}"/>
                    </div>
                    ...
                    <div class="col-12  mb-3">
                        <x-form.textarea name="health_notes" label=" {{__('ملاحظات على الحالة الصحية')}}"  placeholder="{{__('أدخل ملاحظات على الحالة الصحية')}}"/>
                    </div>

                    {{-- orphanage_management_notes --}}
                    <div class="col-12  mb-3">
                        <x-form.textarea name="orphan_management_notes" label="  {{__('ملاحظات إدارة الأيتام')}}"  placeholder="{{__('أدخل  ملاحظات إدارة الأيتام')}}"/>
                    </div>


                    {{-- address_supervising_authority --}}
                    <div class="col-12 mb-3">
                        <x-form.input name="address_supervising_authority" class="border" type="text" label=" {{__('عنوان الجهة المشرفة')}}" autocomplete="" placeholder="{{__('أدخل عنوان الجهة المشرفة')}}"/>
                    </div>
