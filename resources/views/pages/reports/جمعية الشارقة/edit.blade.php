            ...
            <div class="bg-white p-3 mb-3 rounded shadow-sm">
                ...
                <div class="row" >
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="orphan_name" :value="$report->orphan->name" id="orphan_name" class="border" type="text" label=" {{__('اسم اليتيم')}}" autocomplete="" placeholder=" أدخل اسم اليتيم" readonly/>
                    </div>

                    {{-- orphan_code --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="orphan_code" :value="$report->orphan->internal_code" id="orphan_code" class="border" type="text" label="  {{__('كود اليتيم')}}" autocomplete="" placeholder=" أدخل كود اليتيم "/>
                    </div>
                ...
                <div class="row" >
                    ...
                    {{-- mailbox--}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="sponsor_mailbox" :value="$report->fields['sponsor_mailbox']" class="border" type="email" label=" {{__('صندوق البريد')}} " autocomplete="" placeholder="أدخل صندوق البريد   "/>
                    </div>
                    ...
                    {{-- orphan_fullname --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="orphan_fullname" :value="$report->orphan->name" id="orphan_fullname" class="border" type="text" label=" {{__('اسم الكامل اليتيم')}}" autocomplete="" placeholder=" أدخل اسم الكامل اليتيم" />
                    </div>

                    {{-- orphan_type --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="orphan_type" :value="$report->orphan->gender" id="orphan_type" class="border" type="text" label=" {{__('نوع اليتيم')}}" autocomplete="" placeholder=" أدخل نوع اليتيم"/>
                    </div>

                    {{-- birth_place --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="birth_place" :value="$report->orphan->birth_place" id="birth_place" class="border" type="text" label="  {{__('مكان الميلاد')}}" autocomplete="" placeholder=" أدخل مكان الميلاد "/>
                    </div>

                    {{-- nationality --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="nationality" :value="$report->orphan->getFieldValueByDatabaseName('nationality')" id="nationality" class="border" type="text" label=" {{__('الجنسية')}} " autocomplete="" placeholder=" أدخل الجنسية  "/>
                    </div>

                    {{-- gender --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="gender" :value="$report->orphan->gender" id="gender" class="border" type="text" label=" {{__('الجنس')}} " autocomplete="" placeholder=" أدخل الجنس  "/>
                    </div>

                    {{-- birth_date --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="birth_date" :value="$report->orphan->birth_date" id="birth_date" class="border" type="date" label="  {{__('تاريخ الميلاد')}}" autocomplete=""/>
                    </div>


                    {{-- age --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="age" id="age" :value="$report->orphan->age" class="border" type="text" label=" {{__('السن')}} " autocomplete="" placeholder=" أدخل السن  "/>
                    </div>

                    {{-- reason_continuing_sponsorship--}}
                    <div class="col-12  mb-3">
                        <x-form.textarea name="reason_continuing_sponsorship" :value="$report->orphan->getFieldValueByDatabaseName('reason_continuing_sponsorship')" id="reason_continuing_sponsorship" label=" {{__('سبب استمرار الكفالة بعد البلوغ')}}"  />
                    </div>

                    {{-- father_death --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="father_death_date" :value="$report->orphan->profile->father_death_date" class="border" id="father_death" type="date" label="  {{__('تاريخ وفاة الأب')}}" autocomplete=""/>
                    </div>

                    {{-- mother_name --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="mother_name" :value="$report->orphan->profile->mother_name" class="border" id="mother_name" type="text" label=" {{__('اسم الأم')}}" autocomplete="" placeholder=" أدخل اسم الأم  "/>
                    </div>

                    {{-- mother_death --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="mother_death_date" :value="$report->orphan->profile->mother_death_date" class="border" id="mother_death" type="date" label="  {{__('تاريخ وفاة الأم')}}" autocomplete=""/>
                    </div>

                    {{-- family_number --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="family_number" :value="$report->orphan->family->family_number" class="border" id="family_number" type="number" label=" {{__('عدد افراد الاسرة')}} " min="0" autocomplete="" placeholder=" أدخل عدد افراد الاسرة   "/>
                    </div>


                    {{-- person_responsible--}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="guardian_name" :value="$report->orphan->guardian->guardian_name" class="border" id="guardian_name" type="text" label=" {{__('اسم ولي الأمر')}}"  autocomplete="" placeholder="أدخل اسم  ولي الأمر "/>
                    </div>

                    {{-- relationship_orphan --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="guardian_relationship" :value="$report->orphan->guardian->guardian_relationship" class="border" id="guardian_relationship" type="text" label=" {{__('صلة القرابة')}}" autocomplete="" placeholder="أدخل صلة القرابة"/>
                    </div>

                    {{-- person_responsible_phone --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="phone" class="border" :value="$report->orphan->profile->phone" id="phone" type="text" label=" {{__('الهاتف')}} " autocomplete="" placeholder="أدخل الهاتف "/>
                    </div>

                    {{-- person_responsible_whatsapp --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="whatsapp_phone" id="whatsapp_phone" :value="$report->orphan->getFieldValueByDatabaseName('whatsapp_phone')" class="border" type="text" label=" {{__('هاتف واتس اب')}}" autocomplete="" placeholder="أدخل هاتف واتس اب  "/>
                    </div>
                    ...
                    {{-- housing_type --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="housing_type" :value="$report->orphan->family->housing_type"  id="housing_type" class="border" type="text" label="  {{__('نوع السكن')}} " autocomplete="" placeholder="أدخل نوع السكن   "/>
                    </div>
                ...
                <div class="row" >
                    ...
                    {{-- health_status --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="health_status" id="health_status" :value="$report->orphan->health_status" class="border" type="text" label="  {{__('الحالة الصحية لليتيم')}}" autocomplete="" placeholder="أدخل الحالة الصحية لليتيم"/>
                    </div>
                    ...
                    {{-- academic_stage --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="academic_stage" :value="$report->orphan->profile->academic_stage" id="academic_stage" class="border" type="text" label=" {{__('المرحلة الدراسية')}}" autocomplete="" placeholder="أدخل  المرحلة الدراسية"/>
                    </div>
