            ...
            <div class="bg-white p-3 mb-3 rounded shadow-sm">
                ...
                <div class="row" >
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="orphan_name" id="orphan_name" class="border" type="text" label=" {{__('اسم اليتيم ')}}" autocomplete="" placeholder=" أدخل اسم اليتيم" readonly/>
                    </div>

                    {{-- orphan_code --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="orphan_code" id="orphan_code" class="border" type="text" label="  {{__('كود اليتيم ')}}" autocomplete="" placeholder=" أدخل كود اليتيم "/>
                    </div>


                    {{-- month_number --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="month_number" class="border" type="text" label=" {{__('عن عدد الأشهر ')}}" autocomplete="" placeholder=" أدخل عدد الأشهر  "/>
                    </div>
                ...
                <div class="row" >
                    ...
                    {{-- sponsor_code --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="sponsor_code" class="border" type="text" label=" {{__('كود الكافل ')}}" autocomplete="" placeholder="أدخل كود الكافل"/>
                    </div>
                    ...
                    {{-- phone--}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="sponsor_phone" class="border" type="text" label=" {{__('الهاتف')}}  " autocomplete="" placeholder="أدخل الهاتف  "/>
                    </div>

                    {{-- email--}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="sponsor_email" class="border" type="email" label=" {{__('البريد الالكتروني ')}} " autocomplete="" placeholder="أدخل البريد الالكتروني   "/>
                    </div>

                    {{-- mailbox--}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="sponsor_mailbox" class="border" type="email" label=" {{__('صندوق البريد ')}} " autocomplete="" placeholder="أدخل صندوق البريد   "/>
                    </div>

                    {{-- address--}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="sponsor_address" class="border" type="text" label=" {{__('العنوان')}} " autocomplete="" placeholder="أدخل  العنوان"/>
                    </div>

                    {{-- orphan_fullname --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="orphan_fullname" id="orphan_fullname" class="border" type="text" label=" {{__('اسم الكامل اليتيم ')}}" autocomplete="" placeholder=" أدخل اسم الكامل اليتيم" />
                    </div>

                    {{-- orphan_type --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="orphan_type" id="orphan_type" class="border" type="text" label=" {{__('نوع اليتيم ')}}" autocomplete="" placeholder=" أدخل نوع اليتيم"/>
                    </div>
                    ...
                    {{-- age --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="age" id="age" class="border" type="text" label=" {{__('السن')}} " autocomplete="" placeholder=" أدخل السن  "/>
                    </div>
                    ...
                    {{-- mother_name --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="mother_name" class="border" id="mother_name" type="text" label=" {{__('اسم الأم ')}}" autocomplete="" placeholder=" أدخل اسم الأم  "/>
                    </div>
                    ...
                    {{-- family_number --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="family_number" class="border" id="family_number" type="number" label=" {{__('عدد افراد الاسرة ')}} " min="0" autocomplete="" placeholder=" أدخل عدد افراد الاسرة   "/>
                    </div>


                    {{-- person_responsible--}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="guardian_name" class="border" id="guardian_name" type="text" label=" {{__('اسم ولي الأمر')}}"  autocomplete="" placeholder="أدخل اسم  ولي الأمر "/>
                    </div>

                    {{-- relationship_orphan --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="guardian_relationship" class="border" id="guardian_relationship" type="text" label=" {{__('صلة القرابة ')}}" autocomplete="" placeholder="أدخل صلة القرابة"/>
                    </div>

                    {{-- person_responsible_phone --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="phone" class="border" id="phone" type="text" label=" {{__('الهاتف')}} " autocomplete="" placeholder="أدخل الهاتف "/>
                    </div>

                    {{-- person_responsible_whatsapp --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="whatsapp_phone" id="whatsapp_phone" class="border" type="text" label=" {{__('هاتف واتس اب ')}}" autocomplete="" placeholder="أدخل هاتف واتس اب  "/>
                    </div>


                    {{-- live_mother --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="live_mother" class="border" type="text" label=" {{__('هل يعيش مع امه؟')}}" autocomplete="" placeholder="أدخل هل يعيش مع امه؟  "/>
                    </div>

                    {{-- reason --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="reason_live" class="border" type="text" label="  {{__('السبب')}}  " autocomplete="" placeholder="أدخل السبب  "/>
                    </div>

                    {{-- housing_type --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="housing_type"  id="housing_type" class="border" type="text" label="  {{__('نوع السكن ')}} " autocomplete="" placeholder="أدخل نوع السكن   "/>
                    </div>
                ...
                <div class="row" >
                    ...
                    {{-- conditions_orphan--}}
                    <div class="col-12  mb-3">
                        <x-form.textarea name="conditions_orphan" label=" {{__('الأحوال التي مر بها اليتيم مؤخرا و عائلته')}}"  value="أدخل الأحوال التي مر بها اليتيم مؤخرا و عائلته "/>
                    </div>

                    {{-- health_status --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="health_status" id="health_status" class="border" type="text" label="  {{__('الحالة الصحية لليتيم')}}" autocomplete="" placeholder="أدخل الحالة الصحية لليتيم"/>
                    </div>

                    {{-- chronic_disease --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="chronic_disease" class="border" type="text" label="  {{__('مرض مزمن ')}} " autocomplete="" placeholder="أدخل  مرض مزمن"/>
                    </div>

                    {{-- Type_disease --}}
                    <div class="col-12  mb-3">
                        <x-form.input name="Type_disease" class="border" type="text" label="  {{__('نوع المرض و أسبابه ')}}" autocomplete="" placeholder="أدخل  نوع المرض و أسبابه"/>
                    </div>
                    ...
                    {{-- reason_notStudying --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="reason_notStudying" class="border" type="text" label=" {{__('سبب عدم الدراسة ')}}" autocomplete="" placeholder="أدخل سبب عدم الدراسة "/>
                    </div>

                    {{-- alternative_approach --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="alternative_approach" class="border" type="text" label="  {{__('التوجه البديل ')}} " autocomplete="" placeholder="أدخل التوجه البديل  "/>
                    </div>

                    {{-- actions_supervisor --}}
                    <div class="col-12  mb-3">
                        <x-form.input name="actions_supervisor" class="border" type="text" label="  {{__('الاجراءات التي اتخذها المشرف ')}} " autocomplete="" placeholder="أدخل الاجراءات التي اتخذها المشرف "/>
                    </div>

                    {{-- regular_praying --}}
                    <div class="col-2  mb-3">
                        <x-form.input name="regular_praying" class="border" type="text" label="  {{__('يواظب على الصلاة ')}}" autocomplete="" placeholder=" أجب بنعم أو لا "/>
                    </div>

                    {{-- actions_supervisor_praying --}}
                    <div class="col-10 mb-3">
                        <x-form.input name="actions_supervisor_praying" class="border" type="text" label="  {{__('الاجراءات التي اتخذها المشرف ')}} " autocomplete="" placeholder="أدخل الاجراءات التي اتخذها المشرف "/>
                    </div>

                    {{-- ramadan_fasting --}}
                    <div class="col-2  mb-3">
                        <x-form.input name="ramadan_fasting" class="border" type="text" label="  {{__('صوم رمضان ')}}" autocomplete="" placeholder=" أجب بنعم أو لا "/>
                    </div>


                    {{-- actions_supervisor_ramadan --}}
                    <div class="col-10  mb-3">
                        <x-form.input name="actions_supervisor_ramadan" class="border" type="text" label="  {{__('الاجراءات التي اتخذها المشرف ')}} " autocomplete="" placeholder="أدخل الاجراءات التي اتخذها المشرف "/>
                    </div>

                    {{--quran_memorized? --}}
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="quran_memorized" class="border" type="text" label="   {{__('كم يحفظ من القران الكريم ')}}" autocomplete="" placeholder=" أدخل كم يحفظ من القران الكريم "/>
                    </div>
                ...
                <div class="row" >
                    ...
                    <!-- orphan_supervisor -->
                    <div class="col-12 col-md-6 mb-3">
                        <x-form.input name="orphan_supervisor"  class="border" type="text" label=" {{__('مشرف الأيتام ')}} "  placeholder="أدخل مشرف الأيتام  "/>
                    </div>
