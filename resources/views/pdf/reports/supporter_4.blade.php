        ...
        <div class="border" style="margin-bottom: 5px; padding:2px">
            ...
            <div style="width: 100%;margin-top:15px">
                ...
                <div style="width: 41%;  text-align:center; float: right;">
                    ...
                    <p style="float: left; width:58%;" class="cell1 border1"> {{ 
            ...
            <div style="width: 74%;margin-top:15px">
                ...
                <p style="float: left; width:55%;" class="cell1 border1"> {{$report->orphan->guardian->guardian_name ?? $report->fields['guardian_name']}} </p>
            ...
            <div style="width:45%;margin-top:15px">
                ...
                <p style="float: left; width:57%;" class="cell1 border1"> {{$report->orphan->guardian->guardian_relationship ?? $report->fields['guardian_relationship']}} </p>
