...
<head>
    ...
    <style>
        ...
        .container > div {
            margin-bottom: 2px; /* لو بدك مسافة صغيرة جداً بين الأقسام */
        }
    ...
    <div class="container">
        ...
        <div style="width: 100%;">
                ...
                <div style="width: 100% ;">
                    ...
                    <div style="width: 100%;margin-top:0px">
                        ...
                        <div style="width: 100%; overflow: hidden;margin-bottom:2px">
                            <p style="float: right; width:30%;background-color:#F4F4F4;" class="cell center border2"> اسم الجهة المشرفة </p>
                            <p style="float: left; width:66%; background-color:#DDE4FF;" class="cell border"> {{$report->fields['supervising_authority']}} </p>
                        </div>
                        ...
                        <div style="width: 100%;  float: right; text-align:center;margin-top:1px">
                            ...
                            <p style="float: left; width:66%; background-color:#DDE4FF;text-align:right;" class="cell border"> {{$report->fields['supervising_authority_country']}} </p>
                        </div>
            ...
            <div style="float: left; width:29%;" class="border">
                <img src="{{ public_path('storage/' . $report->orphan->image->orphan_image_4_6) }}" alt="صورة" width="100%" height="400px">
            </div>
        ...
        <div style="width: 100%;">
            ...
            <div style="width: 100%;margin-top:1px">
                ...
                <div style="width: 33%;  float: left; text-align:center;">
                    ...
                    <p style="float: left; width:62%; background-color:#DDE4FF;" class="cell border"> {{$report->orphan->age ?? $report->fields['age']}} </p>
                </div>
        ...
        <div style="width: 100%;">
            ...
            <div style="width: 100%;">
                <p style="float: right; width:29%;height:30px;background-color:#F4F4F4;" class="cell center border2"> الحالة الصحية لليتيم </p>
                <p style="float: left; width:67%;height:30px; background-color:#DDE4FF;" class="cell border"> {{$report->orphan->health_status ?? $report->fields['health_status']}} </p>
            </div>
            ...
            @if(($report->orphan->health_status == "مريض") || ($report->fields['health_status'] == "مريض"))
                <div style="width: 100%;">
                    ...
                    <p style="float: left; width:67%;height:30px; background-color:#DDE4FF;" class="cell border"> {{ $report->orphan->disease_description
        ...
        <div style="width: 100%;">
            ...
            <div style="width: 100%;margin-top:1px">
                <div style="width: 33%; float: right; overflow: hidden;">
                    ...
                    <p style="float: left; width:44%; background-color:#DDE4FF;" class="cell border"> {{$academic_stage ?: $report->fields['academic_stage']}} </p>
                </div>
            ...
            <div style="width: 100%;margin-top:3px">
                ...
                <div style="width: 49%;  float: left; text-align:center;">
                    <p style="float: right; width:55%;background-color:#F4F4F4;" class="cell center border2"> حفظ اليتيم من القران الكريم </p>
                    <p style="float: left; width:39%; background-color:#DDE4FF;" class="cell border"> {{$report->fields['save_orphan_quran']}} </p>
                </div>
            </div>
        ...
        <div style="width: 100%; ">
            ...
            <div style="width: 100%; margin-top:3px">
                <p style="float: right; width:30%;height:50px;background-color:#F4F4F4;" class="cell center border2">
                    أبرز التغيرات التي طرأت على اليتيم في هذه السنة
                </p>
                <p style="float: left; width:67%; height:54px; background-color:#DDE4FF;" class="cell border"> {{$report->fields['changes_orphan_year']}} </p>
            </div>
